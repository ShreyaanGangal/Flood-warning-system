...
test_station_1 = MonitoringStation("Station ID 1", "Measure ID 1", "Label 1", (3,4), (5,6),"River 1", "Town 1") 
test_station_2 = MonitoringStation("Station ID 2", "Measure ID 2", "Label 2", (-6,8), None,"River 2", "Town 2") 
test_station_3 = MonitoringStation("Station ID 3", "Measure ID 3", "Label 3", (0,-15), (3,4),"River 3", "Town 3") 
